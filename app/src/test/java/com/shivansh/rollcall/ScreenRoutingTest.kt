...
/**
 * Guards the routing rule AnimatedContent depends on.
 *
 * The outgoing screen still renders while it fades, so reading live state there
 * gives a stale cast. Reading Done through a Working cast crashed the app the
 * instant processing hit 100%.
 */
